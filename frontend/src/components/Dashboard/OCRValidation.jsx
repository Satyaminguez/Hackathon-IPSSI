          ...
          <div className="p-8 bg-slate-900/60 border border-slate-800 rounded-lg space-y-8 relative overflow-hidden backdrop-blur-md">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800/50 space-y-3">
              ...
              {/* Statut Alerte */}
              <div className={`p-4 rounded-2xl flex items-start gap-3 ${selectedFile?.incoherence ? 'bg-amber-500/10 border border-amber-500/20' : 'bg-emerald-500/10 border border-emerald-500/20'}`}>
