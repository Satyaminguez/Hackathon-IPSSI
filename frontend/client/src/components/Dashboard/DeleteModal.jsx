    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-900 border border-slate-800 rounded-lg p-8 max-w-sm w-full shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Supprimer le document</h3>
          <p className="text-slate-400 text-sm mb-8 leading-relaxed">
            Êtes-vous sûr de vouloir supprimer <span className="text-white font-semibold">"{itemName}"</span> ? Cette action est irréversible.
          </p>
