      ...
      <div className="py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            <div className="bg-slate-900 shadow-2xl rounded-lg px-6 py-12 ring-1 ring-gray-200 border-2 border-slate-600">
            ...
            <div className="bg-slate-900 shadow-xl rounded-lg px-6 py-12 ring-1 ring-gray-200 border border-slate-300">
